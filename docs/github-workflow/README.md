...
この手順書は、GitHubでのチーム開発が初めての人が、Issueを選ぶところからPull Requestのマージまでを一人で進められるようにするためのものです。
...
2. [GitとGitHubの基礎](02-concepts.md)：開発の全体像と、使う用語
...
- [CONTRIBUTING.md](../CONTRIBUTING.md)：開発運用の規則をまとめた参照用ドキュメント。各ページから規則の詳細へリンクしています。
