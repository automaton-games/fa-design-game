...
実装するプロダクトの範囲や画面を確認するときに参照します。詳しくは[プロダクト仕様の一覧](product/README.md)を参照してください。
...
APIやデータ形式など、実装時に参照する仕様です。詳しくは[技術仕様の一覧](reference/README.md)を参照してください。
...
開発環境の準備や作業手順を確認するときに参照します。詳しくは[開発ガイドの一覧](guides/README.md)を参照してください。
